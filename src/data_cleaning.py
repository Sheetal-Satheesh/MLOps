...
class DataPreProcessStrategy(DataStrategy):
    """
    Strategy responsible for processing data
    """
...
class DataDivideStrategy(DataStrategy):
    def handle_data(self, data: pd.DataFrame) -> Union[pd.DataFrame, pd.Series]:
        ...
        """
        try:
            # Verify the columns in the initial DataFrame
            logging.info(f"Initial columns in the DataFrame: {data.columns.tolist()}")
            ...
            logging.error("Error in dividing teh data:{}".format(e))
            raise e


class DataCleaning:
    """
    Class for cleaning the data which process the data and divides it into train and test
    """
